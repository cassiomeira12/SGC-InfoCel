...
CREATE TABLE IF NOT EXISTS `neoli831_teste`.`manutencao` (
  ...
  `data_cadastro` BIGINT(20) NOT NULL,
  `data_previsao` BIGINT(20) NOT NULL,
  `data_entrega` BIGINT(20) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neoli831_teste`.`view_cliente` (`id` INT, `nome` INT, `endereco` INT, `cpf` INT, `rg` INT, `telefone` INT, `cidade` INT, `data_cadastro` INT, `status` INT, `id_endereco` INT, `numero` INT, `rua` INT, `id_bairro` INT, `id_cidade` INT, `nome_cidade` INT, `nome_bairro` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neoli831_teste`.`view_manutencao` (`id` INT, `id_administrador` INT, `id_cliente` INT, `id_forma_pagamento` INT, `descricao` INT, `marca` INT, `modelo` INT, `imei` INT, `cor` INT, `data_cadastro` INT, `data_previsao` INT, `data_entrega` INT, `preco` INT, `finalizado` INT, `nome_administrador` INT, `nome_cliente` INT);

-- -----------------------------------------------------
-- Placeholder table for view `neoli831_teste`.`view_produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neoli831_teste`.`view_produto` (`id` INT, `id_marca` INT, `id_unidade_medida` INT, `id_categoria_produto` INT, `descricao` INT, `preco_compra` INT, `preco_venda` INT, `estoque` INT, `eh_celular` INT, `descricao_marca` INT, `descricao_categoria` INT, `descricao_unidade` INT);

-- -----------------------------------------------------
-- Placeholder table for view `neoli831_teste`.`view_receita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neoli831_teste`.`view_receita` (`id` INT, `id_administrador` INT, `id_cliente` INT, `descricao` INT, `data` INT, `valor` INT, `nome_cliente` INT, `nome_administrador` INT);

-- -----------------------------------------------------
-- Placeholder table for view `neoli831_teste`.`view_saida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neoli831_teste`.`view_saida` (`id` INT, `id_administrador` INT, `id_categoria_saida` INT, `descricao` INT, `valor` INT, `data` INT, `nome_administrador` INT, `descricao_categoria` INT);

-- -----------------------------------------------------
-- Placeholder table for view `neoli831_teste`.`view_venda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neoli831_teste`.`view_venda` (`id` INT, `id_forma_pagamento` INT, `id_administrador` INT, `id_cliente` INT, `preco_total` INT, `data` INT, `quantidade_parcela` INT, `nome_cliente` INT, `nome_administrador` INT, `descricao_forma_pagamento` INT);
...
USE `neoli831_teste`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`neoli831`@`localhost` SQL SECURITY DEFINER VIEW `neoli831_teste`.`view_cliente` AS select `neoli831_teste`.`cliente`.`id` AS `id`,`neoli831_teste`.`cliente`.`nome` AS `nome`,`neoli831_teste`.`cliente`.`endereco` AS `endereco`,`neoli831_teste`.`cliente`.`cpf` AS `cpf`,`neoli831_teste`.`cliente`.`rg` AS `rg`,`neoli831_teste`.`cliente`.`telefone` AS `telefone`,`neoli831_teste`.`cliente`.`cidade` AS `cidade`,`neoli831_teste`.`cliente`.`data_cadastro` AS `data_cadastro`,`neoli831_teste`.`cliente`.`status` AS `status`,`neoli831_teste`.`cliente`.`id_endereco` AS `id_endereco`,`view_endereco`.`numero` AS `numero`,`view_endereco`.`rua` AS `rua`,`view_endereco`.`id_bairro` AS `id_bairro`,`view_endereco`.`id_cidade` AS `id_cidade`,`view_endereco`.`nome_cidade` AS `nome_cidade`,`view_endereco`.`nome_bairro` AS `nome_bairro` from (`neoli831_teste`.`cliente` join `neoli831_teste`.`view_endereco` on((`neoli831_teste`.`cliente`.`id_endereco` = `view_endereco`.`id_endereco`)));
...
USE `neoli831_teste`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`neoli831`@`localhost` SQL SECURITY DEFINER VIEW `neoli831_teste`.`view_manutencao` AS select `neoli831_teste`.`manutencao`.`id` AS `id`,`neoli831_teste`.`manutencao`.`id_administrador` AS `id_administrador`,`neoli831_teste`.`manutencao`.`id_cliente` AS `id_cliente`,`neoli831_teste`.`manutencao`.`id_forma_pagamento` AS `id_forma_pagamento`,`neoli831_teste`.`manutencao`.`descricao` AS `descricao`,`neoli831_teste`.`manutencao`.`marca` AS `marca`,`neoli831_teste`.`manutencao`.`modelo` AS `modelo`,`neoli831_teste`.`manutencao`.`imei` AS `imei`,`neoli831_teste`.`manutencao`.`cor` AS `cor`,`neoli831_teste`.`manutencao`.`data_cadastro` AS `data_cadastro`,`neoli831_teste`.`manutencao`.`data_previsao` AS `data_previsao`,`neoli831_teste`.`manutencao`.`data_entrega` AS `data_entrega`,`neoli831_teste`.`manutencao`.`preco` AS `preco`,`neoli831_teste`.`manutencao`.`finalizado` AS `finalizado`,`neoli831_teste`.`administrador`.`nome` AS `nome_administrador`,`neoli831_teste`.`cliente`.`nome` AS `nome_cliente` from ((`neoli831_teste`.`manutencao` join `neoli831_teste`.`administrador` on((`neoli831_teste`.`manutencao`.`id_administrador` = `neoli831_teste`.`administrador`.`id`))) join `neoli831_teste`.`cliente` on((`neoli831_teste`.`manutencao`.`id_cliente` = `neoli831_teste`.`cliente`.`id`)));
...
USE `neoli831_teste`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`neoli831`@`localhost` SQL SECURITY DEFINER VIEW `neoli831_teste`.`view_produto` AS select `neoli831_teste`.`produto`.`id` AS `id`,`neoli831_teste`.`produto`.`id_marca` AS `id_marca`,`neoli831_teste`.`produto`.`id_unidade_medida` AS `id_unidade_medida`,`neoli831_teste`.`produto`.`id_categoria_produto` AS `id_categoria_produto`,`neoli831_teste`.`produto`.`descricao` AS `descricao`,`neoli831_teste`.`produto`.`preco_compra` AS `preco_compra`,`neoli831_teste`.`produto`.`preco_venda` AS `preco_venda`,`neoli831_teste`.`produto`.`estoque` AS `estoque`,`neoli831_teste`.`produto`.`eh_celular` AS `eh_celular`,`neoli831_teste`.`marca`.`descricao` AS `descricao_marca`,`neoli831_teste`.`categoria_produto`.`descricao` AS `descricao_categoria`,`neoli831_teste`.`unidade_medida`.`descricao` AS `descricao_unidade` from (((`neoli831_teste`.`produto` join `neoli831_teste`.`marca` on((`neoli831_teste`.`produto`.`id_marca` = `neoli831_teste`.`marca`.`id`))) join `neoli831_teste`.`unidade_medida` on((`neoli831_teste`.`produto`.`id_unidade_medida` = `neoli831_teste`.`unidade_medida`.`id`))) join `neoli831_teste`.`categoria_produto` on((`neoli831_teste`.`produto`.`id_categoria_produto` = `neoli831_teste`.`categoria_produto`.`id`)));
...
USE `neoli831_teste`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`neoli831`@`localhost` SQL SECURITY DEFINER VIEW `neoli831_teste`.`view_receita` AS select `neoli831_teste`.`receita`.`id` AS `id`,`neoli831_teste`.`receita`.`id_administrador` AS `id_administrador`,`neoli831_teste`.`receita`.`id_cliente` AS `id_cliente`,`neoli831_teste`.`receita`.`descricao` AS `descricao`,`neoli831_teste`.`receita`.`data` AS `data`,`neoli831_teste`.`receita`.`valor` AS `valor`,`neoli831_teste`.`cliente`.`nome` AS `nome_cliente`,`neoli831_teste`.`administrador`.`nome` AS `nome_administrador` from ((`neoli831_teste`.`receita` join `neoli831_teste`.`cliente` on((`neoli831_teste`.`receita`.`id_cliente` = `neoli831_teste`.`cliente`.`id`))) join `neoli831_teste`.`administrador` on((`neoli831_teste`.`receita`.`id_administrador` = `neoli831_teste`.`administrador`.`id`)));
...
USE `neoli831_teste`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`neoli831`@`localhost` SQL SECURITY DEFINER VIEW `neoli831_teste`.`view_saida` AS select `neoli831_teste`.`saida`.`id` AS `id`,`neoli831_teste`.`saida`.`id_administrador` AS `id_administrador`,`neoli831_teste`.`saida`.`id_categoria_saida` AS `id_categoria_saida`,`neoli831_teste`.`saida`.`descricao` AS `descricao`,`neoli831_teste`.`saida`.`valor` AS `valor`,`neoli831_teste`.`saida`.`data` AS `data`,`neoli831_teste`.`administrador`.`nome` AS `nome_administrador`,`neoli831_teste`.`categoria_saida`.`descricao` AS `descricao_categoria` from ((`neoli831_teste`.`saida` join `neoli831_teste`.`administrador` on((`neoli831_teste`.`saida`.`id_administrador` = `neoli831_teste`.`administrador`.`id`))) join `neoli831_teste`.`categoria_saida` on((`neoli831_teste`.`saida`.`id_categoria_saida` = `neoli831_teste`.`categoria_saida`.`id`)));
...
USE `neoli831_teste`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`neoli831`@`localhost` SQL SECURITY DEFINER VIEW `neoli831_teste`.`view_venda` AS select `neoli831_teste`.`venda`.`id` AS `id`,`neoli831_teste`.`venda`.`id_forma_pagamento` AS `id_forma_pagamento`,`neoli831_teste`.`venda`.`id_administrador` AS `id_administrador`,`neoli831_teste`.`venda`.`id_cliente` AS `id_cliente`,`neoli831_teste`.`venda`.`preco_total` AS `preco_total`,`neoli831_teste`.`venda`.`data` AS `data`,`neoli831_teste`.`venda`.`quantidade_parcela` AS `quantidade_parcela`,`neoli831_teste`.`cliente`.`nome` AS `nome_cliente`,`neoli831_teste`.`administrador`.`nome` AS `nome_administrador`,`neoli831_teste`.`forma_pagamento`.`descricao` AS `descricao_forma_pagamento` from (((`neoli831_teste`.`venda` join `neoli831_teste`.`cliente` on((`neoli831_teste`.`venda`.`id_cliente` = `neoli831_teste`.`cliente`.`id`))) join `neoli831_teste`.`forma_pagamento` on((`neoli831_teste`.`venda`.`id_forma_pagamento` = `neoli831_teste`.`forma_pagamento`.`id`))) join `neoli831_teste`.`administrador` on((`neoli831_teste`.`venda`.`id_administrador` = `neoli831_teste`.`administrador`.`id`)));
